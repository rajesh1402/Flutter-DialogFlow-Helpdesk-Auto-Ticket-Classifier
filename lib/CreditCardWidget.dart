...
import 'package:stripe_demo/pages/drawer2.dart';
...
class _CreditCardWidget extends State<CreditCardWidget> {
  ...
  FocusNode emailIDFocus, cardNumberFocus, cardNameFocus, expiryFocus, cvvFocus;
                      ...
                      Container(
                          ...
                          child: TextFormField(
                            ...
                            onFieldSubmitted: (String val) {
                              Navigator.of(context).focusScopeNode.requestFocus(cardNumberFocus);
                            },
                ...
                Container(
                    ...
                    child:FlatButton(onPressed: () async {
                      ...
                      if ((!isNumeric(cardValue)) && (cardValue.length >= 16) && (strMonthAndYear == null) && (cvv.length > 2) ){
                          await _getstripeToken();
                          print('Paytoken is $_stripeToken');
                          // Call API
                      ...
                      child: new Column(
                        ...
                        children: <Widget>[
                          new Text("Pay \$19.99",style: TextStyle(color: Colors.white,fontFamily: "SemiBoldFont", fontSize: 18.0))
                        ],
                      ),
                    )
